import{f as d,h as _,j as u,ag as h,c as m,ah as p,l as n,ai as t,aj as s,y as o,F as f,ak as g,al as v,am as x,n as r,an as b,ao as y,m as k,ap as N,aq as w,_ as P}from"./nav-98e44c24.js";import{N as V}from"./NoteViewer-49c08b06.js";import{u as j}from"./index-70bc5d17.js";const S={class:"m-4"},L={class:"mb-10"},T={class:"text-4xl font-bold mt-2"},B={class:"opacity-50"},C={class:"text-lg"},H={class:"font-bold flex gap-2"},z={class:"opacity-50"},D=t("div",{class:"flex-auto"},null,-1),F={key:0,class:"border-gray-400/50 mb-8"},M=d({__name:"PresenterPrint",setup(q){_(u),h(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
